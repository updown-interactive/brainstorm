import { nameFromPath } from '../../markdown/engine/frontmatter';
import { getVaultIndex, type IndexedFile } from '../../files/data/vault-index';
import type { KnowledgeNode, KnowledgeEdge, KnowledgeGraph, KnowledgeEdgeType } from '../types';
...
function addEdge(edges: Map<string, KnowledgeEdge>, source: string, target: string, type: KnowledgeEdgeType): void {
